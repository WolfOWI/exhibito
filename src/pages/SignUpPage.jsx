        ...
        <div className="row">
          ...
          <div className="col-4 ">
            ...
            <form onSubmit={handleSubmit} className="form1 py-5">
              ...
              <p>Join our community of art enthusiasts and gain access to exclusive exhibitions and events.</p>
              <ul>
                <li>
                  <label>
                    Name and Surname:
                ...
                <li>
                  ...
                  <div className="dropdown">
                    <select className="form-select" name="occupancy" value={formData.occupancy} onChange={handleChange} required>
